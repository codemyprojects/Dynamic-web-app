...
<button type="button" class="btn btn-default btn-sm" style="background-color:#CCCCFF;">
          <span class=""></span>   <i class="icon-home icon-large" style="font-size:16px; margin-left:100px; background-color:#669999;"></i><a href="index.php" style="font-size:16px; text-decoration:none; font-style:normal; margin-right:0px; text-transform:capitalize;"> Home </a>
		...
		<div class="alert alert-success">
			<strong>WELCOME</strong> HIMS-NEPAL.
			...
			<div class="rightcont">    <br>
                    ...
                    <div class="p1">
						...
						<P align="justify" style=""><font color="#000000">
                        <?php echo $datappage['pagedesc']; ?> </p>
                        <br />
                        <br />
                        <img src="pageimages/<?php echo $datappage['image']; ?>" />
...
<footer style=" background-color: #003333; color:#FFFFFF;">
