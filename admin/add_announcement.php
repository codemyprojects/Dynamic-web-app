...
<div class="container-fluid">
 <div class="row-fluid">
  ...
  <ul>
    ...
    <li> <a href="author.php"><i class="icon icon-arrow-left"></i> List of Announcement </a></li>
    <li class="disabled"><a href="#"><i class="icon-plus-sign icon-large"></i> Add Photo</a></li>
  </ul>
</div>
...
<div class="above_table">
	<div class="form_center">
			...
			<form method="POST" action="save_addannouncement.php" enctype="multipart/form-data">
			 <div class="control-group">
    <label class="control-label" for="inputEmail">Title:</label>
    <div class="controls">
      <input type="text" id="inputEmail" name="title" placeholder="Title" required>
    </div>
  </div>
   ...
   <button name="add_announcement" type="submit" class="btn-large btn-success"><i class="icon-save icon-large"></i> Save</button>
