    ...
    <div id="slider1_container" style="position: relative; width: 475px;
        ...
        <!-- Loading Screen -->
        <div ="loading" style="position: absolute; top: 0px; left: 0px;">
        ...
        <div u="slides" style="cursor: move; position: absolute; border-radius:5px; border:1px solid #aaa; left: 0px; top: 0px; width: 600px; height: 300px;
            overflow: hidden;">
                 ...
                 <?php 
                                ...
                                <div>
                				<img src="gallery/<?php echo $data['imgname']; ?>"  alt="">
                                
                                </div>
                                
								<p style="color: #FFFF99; background-color:#CCCCCC; opacity:40em;"><?php echo $data['caption'];?></p>
